# account-unban-reactivate Review Context
...
### invariant
- `features/account-management/overview` [invariant] account-management — overview — `intents/emumet/features/account-management/overview.md`
### decider
- (none overlapping this packet's intent_references)
### acceptance-property
- (none overlapping this packet's intent_references)
