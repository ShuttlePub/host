# account-write-usecases Review Context
...
- widens scope beyond the issue contract (e.g. starts migrating Profile/Metadata to ES repository, or implements Block/Inbox Follow tx);
